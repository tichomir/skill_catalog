...
_Document ID: TCR-RHCW-005 | Version: 1.1 | Status: Final_
_Date: 2026-04-03 | QA Engineer: QA Engineer Persona_
_Sprint: 5 — Testing and QA (canonical path established Sprint 6)_
_Standards reference: BT-2026-Q2 (references/brand-and-tone-notes.md v1.0.1)_
...
`rhel-copywriter-skill/standards/terminology-list.md` Section 2, including morphological
variants.
...
| F-02 | First sentence of every section states partner/customer outcome | Yes | Headline: partner outcome first. Body bullet 1: customer outcome first. CTA: action naming Wipro first. |
...
_Standards version applied: BT-2026-Q2 | brand-and-tone-notes.md: v1.0.1_
_Canonical path: docs/copywriter/qa/tone-check-report.md_
