...
**Output file:** `docs/qa/test-01-partner-value-prop-output.md`
...
**Output file:** `docs/qa/test-02-before-you-go-output.md`
...
**Output file:** `docs/qa/test-03-announcement-blurb-output.md`
