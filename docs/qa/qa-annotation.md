...
|---|---|---|---|---|
| TEST-01 | `docs/qa/test-01-partner-value-prop-input.yaml` | `docs/qa/test-01-partner-value-prop-output.md` | `partner_value_prop` | Partner value proposition (Wipro / OpenShift) |
| TEST-02 | `docs/qa/test-02-before-you-go-input.yaml` | `docs/qa/test-02-before-you-go-output.md` | `summit_prep` | Before You Go slide narrative (Accenture / RHEL) |
| TEST-03 | `docs/qa/test-03-announcement-blurb-input.yaml` | `docs/qa/test-03-announcement-blurb-output.md` | `summit_prep` | Announcement blurb (DXC Technology / Ansible) |
