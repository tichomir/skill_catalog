# Decision Record: Q-04
## Approved Red Hat Terminology List and Banned Terms
...
| Sourced from | J. Morales (PMM) — direct provision |
| Reviewed by | T. Okafor (GTM Lead), R. Patel (Skill Owner) |
| Terminology version | TERM-2026-Q2 |

---

## Context

The Red Hat Copywriter Skill must enforce correct product and brand terminology to avoid messaging inconsistencies, legal exposure, and brand dilution. This record documents the approved terminology list and the banned terms list as sourced directly from PMM (J. Morales) on 2026-04-02.

This list is the authoritative input for the skill's terminology audit capability (see PRD Section 5). It is committed to `/rhel-copywriter-skill/standards/terminology-list.md`.

---

## Approved Product and Brand Names

The following names must be used exactly as written (capitalisation, spacing, and hyphenation as shown).
...
The following terms must not appear in Red Hat-authored or Red Hat-attributed copy under any circumstances.
...
### Competitor Names (direct reference)
...
_Sourced from J. Morales (PMM) on 2026-04-02. This list supersedes any prior informal terminology guidance. Version TERM-2026-Q2._
